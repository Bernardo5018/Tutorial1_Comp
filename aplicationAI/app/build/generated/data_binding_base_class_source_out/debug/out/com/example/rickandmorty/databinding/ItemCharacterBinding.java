...
public final class ItemCharacterBinding implements ViewBinding {
  ...
  private ItemCharacterBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivAvatar,
  ...
  public static ItemCharacterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCharacterBinding((MaterialCardView) rootView, ivAvatar, tvName, tvStatus);
    }
